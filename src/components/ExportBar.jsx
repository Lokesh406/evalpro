...
<body>
  ...
  <div class="footer">Generated by EvalPro · Professional Assessment System for Vignan University · Secure & Private · Runs entirely in your browser</div>
</body>
</html>`;
}
...
export default function ExportBar({ subjects, studentName, regNo = "", dark, onTrend, onEmail, onAnalytics }) {
  ...
  return (
    <div style={{ marginTop: 24, padding: "14px 0" }}>
      <div style={{ fontSize: 12, fontWeight: 700, color: "rgba(0,0,0,0.4)", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: 12 }}>
        Export Report
      </div>
      <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
        ...
        {btn(() => setShowShare(true), "rgba(245,158,11,0.08)", "rgba(245,158,11,0.2)", "#f59e0b", <Share2 size={14} />, "Share Link", false)}
